  ...
  <body>
    ...
    margin-bottom: 200px;">
  						<div class="panel-heading">
							<h2>Ubah Background Home</h2>
						</div>
  						<div class="panel-body">
  							<form method="post" enctype="multipart/form-data" action="<?=base_url()?>Admin/Login/simpanGbrHome" accept-charset="utf-8" class="form-horizontal">									 
